...
Um jogo da memória desenvolvido em **Python** utilizando **Tkinter**.

O objetivo é encontrar todos os pares de cartas iguais, testando a memória e a lógica do jogador.
